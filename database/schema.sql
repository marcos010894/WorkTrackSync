...
-- Criação do banco de dados para o sistema de monitoramento

CREATE DATABASE IF NOT EXISTS worktrack_sync CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE worktrack_sync;
...
CREATE TABLE IF NOT EXISTS computers (
    ...
    computer_id VARCHAR(100) NOT NULL UNIQUE, -- ID único gerado pelo agente
...
CREATE TABLE IF NOT EXISTS remote_commands (
    ...
    response_data TEXT,
    FOREIGN KEY (computer_id) REFERENCES computers(computer_id) ON DELETE CASCADE,
    FOREIGN KEY (sent_by) REFERENCES administrators(id) ON DELETE CASCADE,
...
('admin', 'admin@worktrack.com', '$2y$12$3pCyeR1imFE3CZbpKzM0MekQq9PnpWjszm2Whtlbw50vbpgyjyV1u', 'Administrador do Sistema')
