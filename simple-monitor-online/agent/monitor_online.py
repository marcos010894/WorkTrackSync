...
class OnlineActivityMonitor:
    def __init__(self, server_url="https://simple-monitor-online-l91cr1ty0-marcos10895s-projects.vercel.app"):
...
def main():
    # URL do servidor
    server_url = "https://simple-monitor-online-l91cr1ty0-marcos10895s-projects.vercel.app"
